...
A simple console-based quiz app built in Java as part of internship task (Task 8).
This project is designed to demonstrate fundamental programming concepts in Java, including loops, control flow, collections, and object-oriented programming principles.
...
quiz-app-java/
│── src/
│   └── QuizApp.java      (Main class with program logic)
...
1. Clone the repository
   git clone [https://github.com/MURALAAYYAPPA/quiz-app-java.git]

2. Navigate to the project folder
   cd quiz-app-java/src
